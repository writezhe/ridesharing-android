...
public class Step {
    ...
    public Step(Date departureTime, JSONObject step) {
        try {
            ...
            DateFormat formatter2 = new SimpleDateFormat("dd:MM:yyyy hh:mma");
            ...
            if (type.contentEquals("TRANSIT")) {
                ...
                String d = formatter1.format(departureTime) + " " + step.getJSONObject("transit_details").getJSONObject("departure_time").getString("text");
