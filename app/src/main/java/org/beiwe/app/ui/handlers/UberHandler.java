...
public class UberHandler {
	...
	public static void showUber(RideRequestButton rideRequestButton, LatLng pickup, LatLng dropOff) {
		RideParameters rideParams = new RideParameters.Builder()
				...
				.setDropoffLocation(dropOff.latitude, dropOff.longitude, "Embarcadero", "One Embarcadero Center, San Francisco") // Price estimate will only be provided if this is provided.
				.build();
