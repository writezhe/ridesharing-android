...
//			return bytesToHex(hasher.digest());
			return Base64.encodeToString(hasher.digest(), Base64.NO_WRAP | Base64.NO_PADDING);
		}
		catch (Exception e) {
			e.printStackTrace();
...
//	}
	...
	public static String encrypt(String text) {
		...
		return Base64.encodeToString(encryptedText, Base64.NO_WRAP | Base64.NO_PADDING);
